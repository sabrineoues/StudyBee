...
**Si on la saute :** ...""",
                ...
                "quiz": f"""Contexte du document :
{context}

Génère un quiz de révision en français, fidèle AU CONTENU fourni uniquement.

Contraintes strictes :
1. Retourne exactement du JSON valide (sans markdown, sans texte autour).
2. Format attendu :
{{
    "title": "...",
    "questions": [
...
3. Génère 8 questions : 6 QCM + 2 vrai/faux (type "true_false" avec options ["Vrai", "Faux"]).
4. Niveau universitaire, couvrant définitions, compréhension, application.
5. Les explications doivent être courtes (1-2 phrases) et pédagogiques.
6. N'invente pas d'information absente du contexte.""",
    }
